...
describe('Ingest Controller', () => {
  ...
  describe('authMiddleware', () => {
    it('deve chamar next() se autenticado', async () => {
      req.headers = { 'x-auth-token': 'key', 'x-channel-id': 'slug' };
      (channelService.findByApiKeyAndSlug as jest.Mock).mockResolvedValue({ id: '1' });
  ...
  describe('createIngestController', () => {
    ...
    // --- Casos para NovoSGA (ADICIONADOS) ---
